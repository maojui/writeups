...
d_left  = '00000000'
d_right = '60000000'
delta = h2s( d_left + d_right )

m2 = n2s(s2n(m1) ^ s2n(delta)).rjust(8,b'\x00') 

key = des3.genkey()

# x = [x[i] for i in rIP]
cipher1 = des3.encrypt_test(switchBS(m1),key,2)
cipher2 = des3.encrypt_test(switchBS(m2),key,2)
# x = [x[i] for i in rIP_1]
print( des3.str_to_bits(cipher1) )
print( des3.str_to_bits(cipher2) )
# [des3.str_to_bits(switchBS(h2s('60000000')))[x-1] for x in E]     