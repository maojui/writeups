...
if __name__ == '__main__':
    ...
    cipher = open('Message.Agency', 'rb').read()
    d = des()

    cc = d.encrypt('13579579','this_is_the_flag')
    print(d.decrypt('02468468',cc))
    
    # 82404044
    print(d.decrypt('82404044',cipher))
    
    # DCTF{eb48205b05403a36152b0836ab0cacba109c69baf9352ad4a0dfa86fc99d09fb}